...
source=("http://taskwarrior.org/download/timew-${pkgver}.tar.gz"
        "on-modify-hook::https://git.tasktools.org/projects/TM/repos/timew/browse/ext/on-modify.timewarrior?at=aa00f436a1d9dea31ac26460af366bc5f8df943e&raw"
...
package() {
    ...
    install -Dvm644 "${srcdir}/on-modify-hook" "${pkgdir}/usr/share/doc/timew/on-modify.timewarrior"
